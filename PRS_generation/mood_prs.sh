...
HOME=/exports/igmm/eddie/GenScotDepression/users/poppy/gsem/corr_factor/gwas/mood
...
Rscript /exports/igmm/software/pkg/el7/apps/PRSice/2.1.11/PRSice.R \
	...
	--extract /exports/igmm/eddie/GenScotDepression/users/poppy/gsem/parcel_factors/prs/alspac_mood_prs1221.valid \
	--pheno-col t1,t2,t3,t4 \
        ...
        --all-score  \
        --print-snp \
        --out /exports/igmm/eddie/GenScotDepression/users/poppy/gsem/parcel_factors/prs/alspac_mood_prs$(date +%m%d)

# Commenting out the second Rscript
# Rscript /exports/igmm/software/pkg/el7/apps/PRSice/2.1.11/PRSice.R \
#         --prsice /exports/igmm/software/pkg/el7/apps/PRSice/2.1.11/PRSice_linux \
#         --base $HOME/merged_file.tsv \
...
#         --all-score  \
#         --print-snp \
#         --out /exports/igmm/eddie/GenScotDepression/users/poppy/gsem/corr_factor/prs/abcd_mood_prs$(date +%m%d)
