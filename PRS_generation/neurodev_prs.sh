...
HOME=/exports/igmm/eddie/GenScotDepression/users/poppy/gsem/corr_factor/gwas/neurodev
...
Rscript /exports/igmm/software/pkg/el7/apps/PRSice/2.1.11/PRSice.R \
        ...
        --extract /exports/igmm/eddie/GenScotDepression/users/poppy/gsem/parcel_factors/prs/alspac_neurodev_prs1221.valid \
	--pheno-file $ALSPAC/pheno_file_alspac_all.txt \
        ...
        --all-score  \
        --print-snp \
        --out /exports/igmm/eddie/GenScotDepression/users/poppy/gsem/parcel_factors/prs/alspac_neurodev_prs$(date +%m%d)
...
Rscript /exports/igmm/software/pkg/el7/apps/PRSice/2.1.11/PRSice.R \
	...
	--pheno-col t0.5,t1,t1.5,t2,t2.5,t3,t3.5,t4 \
        ...
        --all-score  \
        --print-snp \
        --out /exports/igmm/eddie/GenScotDepression/users/poppy/gsem/corr_factor/prs/abcd_neurodev_prs$(date +%m%d)
